...
with open(file_to_save, "w") as txt_file:
    ...
    for county_name in county_votes:
        ...
        if (county_vote_count > largest_county_count) and (county_percentage > largest_county_percentage):
    ...
    largest_county_summary = (
        ...
        #f"Largest County Turnout Vote Count: {largest_county_count:,}\n"
        #f"Largest County Turnout Percentage of Votes: {largest_county_percentage:.1f}%\n"
        f"-------------------------\n")
